...
$data=date("m_d_Y").'.sql';
$handle = fopen('C:\/Systems_Backup\/Accounting_Backup\/db_backup\/'.$data,'w+');

fwrite($handle,$return);

//C:\Users\TradingDept\OneDrive\Accounting_Backup\db_backup
$copysql='C:\/Systems_Backup\/Accounting_Backup\/db_backup\/'.$data; 
rcopy($copysql , "C:\/Onedrive_link\/Accounting_Backup\/db_backup\/".$data);
