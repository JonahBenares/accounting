    ...
    public function export_sales_ledger(){
        ...
        $sheetno=0;
            ...
            if($head->reference_number==$details->reference_number){
                ...
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('M'.$num, $vatable_sales);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('O'.$num, $amount);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('Q'.$num, $vatablebalance);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('S'.$num, $zero_rated_sales);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('U'.$num, $zero_rated);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('W'.$num, $zerobalance);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('Y'.$num, $zero_rated_ecozones);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AA'.$num, $zero_rated_ecozone);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AC'.$num, $zeroecobalance);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AE'.$num, $vat_on_sales);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AG'.$num, $vat);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AI'.$num, $vatbalance);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AK'.$num, $ewt_sales);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AM'.$num, $ewt);
                $objPHPExcel->setActiveSheetIndex($sheetno)->setCellValue('AO'.$num, $ewtbalance);
