                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">                        
                            <div class="row">
                                <div class="col-4">
                                    <h4>Summary of All Unpaid Invoices - Merge</h4>
                                </div>
                                <div class="col-8">
                                    <?php if(!empty($year) || !empty($due)){ ?>
                                        <a href = "<?php echo base_url();?>reports/export_unpaid_invoices_sales_merge/<?php echo $year; ?>/<?php echo $due; ?>/" class = "btn btn-success pull-right">Export to Excel</a>
                                    <?php }else{ ?>
                                        <a href = "<?php echo base_url();?>/reports/export_unpaid_invoices_sales_merge/" class = "btn btn-success pull-right">Export to Excel</a>
                                    <?php } ?>  
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table width="100%">
                                            ...
                                            <td width="20%">
                                                ...
                                                <td width="10%">
                                                    ...
                                                    <button type="button" onclick="filterUnpaidSalesMerge();" class="btn btn-primary btn-block">Filter</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
