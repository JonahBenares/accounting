                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">                        
                            <div class="row">
                                <div class="col-8">
                                    <h4>Consolidation/Summary of all Reserve Sales Transaction</h4>
                                </div>
                                 <div class="col-4">
                                    ...
                                    <form method="POST">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <input type='button' class="btn btn-primary"  onclick="filter_reserve_sales_all()" value="Filter">
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
        ...
        <form method="POST">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <input type='button' class="btn btn-primary"  onclick="export_reserve_salesall()" value="Export">
