                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">                        
                            <div class="row">
                                <div class="col-4">
                                    <h4>Summary of Reserve Total Amount Variance - Main</h4>
                                </div>
                                <div class="col-8">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td width="10%">
                                                    ...
                                                    <button type="button" onclick="filterReserveMainTotal();" class="btn btn-primary btn-block">Filter</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
        ...
        <form method="POST">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <input type='button' class="btn btn-primary"  onclick="exportReserveMainTotal()" value="Export">
