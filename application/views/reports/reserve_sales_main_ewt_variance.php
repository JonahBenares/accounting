                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">                        
                            <div class="row">
                                <div class="col-8">
                                    <h4>Summary of Reserve Sales Total EWT Variance - Main</h4>
                                </div>
                                 <div class="col-4">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td width="10%">
                                                    ...
                                                    <button type="button" onclick="filterResSalesMainEWT();" class="btn btn-primary btn-block">Filter</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </form>
        ...
        <form method="POST">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <input type='button' class="btn btn-primary"  onclick="exportResSalesMainEWT()" value="Export">
