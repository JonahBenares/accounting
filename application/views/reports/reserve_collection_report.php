                        ...
                        <div class="card-header">                        
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    <a href="<?php echo base_url(); ?>reports/export_reserve_collection_report/<?php echo $date; ?>/<?php echo $ref_no; ?>/<?php echo $stl_id; ?>" class="btn btn-success btn-sm pull-right"><span class="fas fa-file-export"></span> Export</a>
                                    <a href="<?php echo base_url(); ?>reports/export_reserve_iemop/<?php echo $date; ?>/<?php echo $ref_no; ?>/<?php echo $stl_id; ?>" class="btn btn-success btn-sm pull-right"><span class="fas fa-file-export"></span> IEMOP Export</a>
                                </div>
                            </div>
                        </div>
                            <div class="card-body">
