                                ...
                                <tbody>
                                    ...
                                    <?php 
                                        ...
                                        foreach($adjust as $ads) {
                                            ...
                                            $data2[$key]['vatables_purchases'][] = "(".number_format($ads['vatables_purchases'] ?? 0, 2).")";
                                            $data2[$key]['vat_on_purchases'][] = "(".number_format($ads['vat_on_purchases'] ?? 0, 2).")";
                                            $data2[$key]['ewt'][] = number_format($ads['ewt'] ?? 0, 2);
                                            $data2[$key]['zero_rated'][] = "(".number_format($ads['zero_rated'] ?? 0, 2).")";
                                            $data2[$key]['net'][] = "(".number_format($ads['net'] ?? 0, 2).")";
                                            $data2[$key]['total'][] = "(".number_format($ads['total'] ?? 0, 2).")";
                                        }
                                        foreach($data2 AS $ad){ 
                                    ?>
                                    <tr>
