                ...
                <td colspan="20">
                    <table class="table-bordered table-hover mb-0" style="width:100%;font-size: 12px;">
                        ...
                        <tr>
                            ...
                            <td class="td-head p-l-5 p-r-5" align="center" style="vertical-align: bottom;" width="9%"><b>Net Sale (Php)</b></td>     
                        ...
                        <tr>
                            <td class="p-l-5 p-r-5 td-yellow" colspan="8" align="left">TOTAL AMOUNT RECEIVABLE on or before, JUNE 25, 2022 &nbsp; &nbsp;&nbsp;        ------------------------------->>>></td>
