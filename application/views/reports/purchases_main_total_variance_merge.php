                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="d-flex justify-content-start">
                                        <span class="badge badge-primary badge-sm" style="margin-right:10px">MERGE</span><h4>Summary of Purchases Total Amount Variance - Main</h4>
                                    </div>
                                </div>
                                <div class="col-4">
