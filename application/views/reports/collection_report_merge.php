                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="d-flex justify-content-start">
                                        <span class="badge badge-primary badge-sm" style="margin-right:10px">MERGE</span><h4>Collection Report </h4>
                                    </div>
                                </div>
                                <div class="col-8">
                                    ...
                                    <a href="<?php echo base_url(); ?>reports/export_collection_report/" class="btn btn-success btn-sm pull-right"><span class="fas fa-file-export"></span> Export</a>
                                    <a href="<?php echo base_url(); ?>reports/export_iemop/" class="btn btn-success btn-sm pull-right"><span class="fas fa-file-export"></span> IEMOP Export</a>
                                </div>
                            </div>
                        </div>
                            <div class="card-body">
