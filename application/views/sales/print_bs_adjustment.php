...
<div style="margin-top:10px" id="printbutton">
    <center>
       ...
       <!--  <button class="btn btn-success " oid="saved" name="submit" onclick="printbs_history()">Print</button> -->
        ...
        <a href='<?php echo base_url(); ?>sales/print_invoice_adjustment/<?php echo $invoice_no; ?>/<?php echo $print_identifier; ?>/<?php echo $count; ?>' class="btn btn-primary button" target="_blank">Invoice</a> 
