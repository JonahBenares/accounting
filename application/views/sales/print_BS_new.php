...
<div style="margin-top:10px" id="printbutton">
    <center>
        ...
        <a href='<?php echo base_url(); ?>sales/print_invoice_multiple_new/<?php echo $sales_detail_id; ?>/<?php echo $print_identifier; ?>/<?php echo $count; ?>' class="btn btn-primary button" target="_blank">Invoice</a> 
                ...
                <td colspan="20" style="padding:5px">
                    <table width="100%" class="table-bordereds">
                        ...
                        <tr>
                            ...
                            <input type="hidden" id="overall_total" name="overall_total" class="form-control" value="<?php echo number_format($sps['overall_total'],2); ?>">
                        </tr> 
                        <?php }  $h++; } $x++; } } ?>
                        <tr>
