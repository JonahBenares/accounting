...
<body>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
            ...
            var redirect = loc+"sales/update_reserve_sales_wesm_flag";
                    ...
                    windowHeight: window.outerHeight,
                     ...
                     var sales_id= document.getElementById("sales_id"+a).value;
                        ...
                        var ref_no= $(".ref_no"+a).val();
                            ...
                            var fname = "OR_CENPRIASP_"+stl_id+"_"+ref_no+"_"+billing_month+"_"+dateuploaded+".pdf";
                            pdf.save("OR_CENPRIASP_"+stl_id+"_"+ref_no+"_"+billing_month+"_"+dateuploaded+".pdf");
