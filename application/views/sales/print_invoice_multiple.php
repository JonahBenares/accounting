...
<page size="A4">
    <div style="margin-left: 20px;margin-right: 75px;">
        <table class="table-bordsersed" width="100%" style="font-size:13px">
            <tr>
                <td width="5%"><br></td>
                <td width="5%"></td>
                <td width="5%"></td>
            ...
            <tr>
                <td colspan="3" style="color:#fff">Billed to:</td>
                <td colspan="12" class=" pl-2"><?php echo $company_name[$x]; ?></td>
                <td></td>
            ...
            <tr>
                ...
                <td colspan="9" class=" pl-2"></td>
                <td style="color:#fff">TIN:</td>
                <td colspan="3" class=" pl-2"><?php echo $tin[$x]; ?></td>
            </tr>
            <tr>
                <td colspan="3" style="color:#fff">Address:</td>
                <td colspan="13" class=" pl-2"><?php echo $address[$x];?></td>
            </tr>
            <tr>
                <td colspan="20">
                    <br>
                    <table width="100%" class="table-borsdered" >
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $vat_sales_cents_sub[$x]; ?></td>
                            <?php }else{ ?>
                            <td colspan="4" align="center"><?php echo "₱ ".number_format($vat_sales_peso[$x],0); ?></td>
                            <td colspan="1" align="center"><?php echo $vat_sales_cents[$x]; ?></td>
                            <?php } ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $zero_rated_cents[$x]; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $zero_rated_cents_sub[$x]; ?></td>
                        </tr>
                        <?php } } ?>
                        <?php 
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $zero_rated_ecozones_cents[$x]; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $zero_rated_ecozones_cents_sub[$x]; ?></td>
                        </tr>
                        <?php 
                            } }
                        ?>
                        ...
                        ?>
                         <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $vat_cents[$x]; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo $vat_cents_sub[$x]; ?></td>
                        </tr>
                        <?php } } ?>
                        <?php 
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo "(".$ewt_cents[$x].")"; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="1" align="center"><?php echo "(".$ewt_cents_sub[$x].")"; ?></td>
                        </tr>
                        <?php } } ?>
                        <tr>
                            <td colspan="15"><br></td>
            ...
            <tr>
                ...
                <?php if($participant_id[$x]!=$participant_id_sub[$x]){ ?>
                <td colspan="15" class="" style="font-size: 11px; padding-top: 5px;"><?php echo ($total_amount[$x]!=0) ? $amount_words[$x] : ''; ?></td>
                <?php } else { ?>
                <td colspan="15" class="" style="font-size: 11px; padding-top: 5px;"><?php echo ($total_amount_sub[$x]!=0) ? $amount_words_sub[$x] : ''; ?></td>
                <?php } ?>
            </tr>
            <tr>
                <td colspan="14"></td>
