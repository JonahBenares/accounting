                ...
                <div class="col-12 col-md-12 col-lg-12 col-sm-6">
                    <div class="card">
                        <div class="card-header">
                            <h4>BIR Monitoring Bulk Update - Sales (Main)</h4>
                        </div>
                        <div class="card-body">
                            <form id='bulkupdatemain'> 
                                <div class="row">
                                    <?php if($saved==0){ ?>
                                    <div class="col-lg-4 col-md-4 col-sm-4 offset-lg-2" >
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="sales_id" id="sales_id">
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $r->sales_id; ?>"><?php echo $r->reference_number; ?></option>
                                                        <?php } ?>
                                            </select>
                                            <?php } else { ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <?php if(empty($sales_id) && empty($identifier)){ ?>
                                                <input type='button' class="btn btn-primary" id='save_updatebulk_main' type="button" onclick="proceed_bulk_update_main()" value="Proceed" style="width:100%">
                                                 <input type='button' class="btn btn-danger" id="cancel_updatebulk_main" onclick="cancelBulkUpdateMain()" value="Cancel Transaction" style='display: none;width:100%'>
                                             <?php } elseif ($saved==0){ ?>
                                                 <input type='button' class="btn btn-danger" id="cancel_updatebulk_main" onclick="cancelBulkUpdateMain()" value="Cancel Transaction" style="width:100%">
                                            <?php } ?>
                                        </div>
                                    </div>
                                <?php } else {?>
                            ...
                            <?php if(!empty($sales_id)){ if($saved==0){ ?>
                            <form method="POST" id="upload_bulkupdate_main">
                                <div id="upload_bulk_update_main">
                                    <hr>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 offset-md-3 offset-lg-3">
                                            <div class="form-group mb-0">
                                                <div class="input-group mb-0">
                                                    <input type="file" class="form-control" name="doc" placeholder="" id="bulkupdate_main">
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary" id="proceed_bulkupdate_main" onclick="upload_bulkupdate_main()"  type="button">Upload</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                         ...
                         <?php if(!empty($identifier) && !empty($details)){ ?>
                            <div class="table-responsive" id="table-main" >
                                <hr>
                        ...
                        <input type="button" id="submitbulkmain" class="btn btn-success btn-md btn-block" onclick="saveBulkUpdateMain();" value="Save">
                        <?php } } }?>
                    </div>
                </div>
            </div>
