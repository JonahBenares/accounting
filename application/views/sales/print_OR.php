            ...
            <td colspan="20">
                <table width="100%" class="table-bosrdered">
                        ...
                        <td class="bor-btm2" colspan="5" rowspan="7" class="p-0">
                            ...
                            <table width="100%" class="table-size" style="border: 0px solid #fff;">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td style="border: 0px solid #000;" width="60%"> VATABLE (V) </td>
                                    <td width="40%" align="right"><?php echo number_format($sum_amount,2); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="border: 0px solid #000;">VAT (12%) </td>
                    ...
                    <tr>
                        ...
                        <td class="bor-btm2" colspan="2"></td>
                        <td class="bor-btm2" colspan="3"></td>
                        <td class="bor-btm2" colspan="2"><?php echo number_format($defint,2); ?></td>
                    </tr>
                    <tr>
                        <td class="bor-btm2" colspan="8" align="right">ENERGY</td>
                        <td class="bor-btm2" colspan="2"></td>
                        <td class="bor-btm2" colspan="3"></td>
                        <td class="bor-btm2" colspan="2"><?php echo number_format($sum_amount,2); ?></td>
                    </tr>
                    <tr>
                        <td class="bor-btm2" colspan="8" align="right">VAT</td>
                        <td class="bor-btm2" colspan="2"></td>
                        <td class="bor-btm2" colspan="3"></td>
                        <td class="bor-btm2" colspan="2"><?php echo number_format($sum_vat,2); ?></td>
                    </tr>
                    <tr>
