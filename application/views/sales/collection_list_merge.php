                        ...
                        <form>
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning alert-dismissible fade show mt-2" role="alert">
                                    ...
                                    <a href="http://localhost/accounting/sales/export_not_download/" target="_blank"><u>Click here</u></a> to check if downloaded files are complete.
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <a href="<?php echo base_url();?>sales/PDF_OR_bulk/" target='_blank' class="btn btn-success btn-block" id="export">Export Bulk PDF</a> 
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                <td class="td-btm pt-1 pb-1" style="vertical-align: middle;" align="center">
                                                    <div style="display:flex">
                                                        <a href="<?php echo base_url(); ?>sales/print_OR_new/" target='_blank' class="btn btn-primary btn-sm text-white" style="margin-right: 2px;">
                                                            <span class="fas fa-print" style="margin:0px"></span>
                                                        </a>
                                                        <a href="<?php echo base_url();?>sales/PDF_OR/" title="Export PDF" target='_blank' class="btn btn-success btn-sm text-white print_pdf" id="print_pdf">
                                                            <span class="fas fa-file-export" style="margin:0px"></span>
                                                        </a>
                                                    </div>
                                                </td>
                                                <td class="td-btm pt-1 pb-1" align="center" style="padding:0px">
                                                    <input  style="border:0px solid #000;background: #dde1ff;padding: 3px;" type="text" name="series_number" id="series_number" value="" onchange="" placeholder='Input Series Number'>
                                                </td>
                                                <td class="td-btm pt-1 pb-1" align="center" style="padding:0px">
                                                    <input  style="border:0px solid #000;background: #dde1ff;padding: 3px;" type="date" name="or_date" id="or_date" value="" onchange="updateORDate">
                                                </td>
                                                    <td class="td-btm pt-1 pb-1" align="center" style="padding:0px">
                                                    <input  style="border:0px solid #000;background: #dde1ff;padding: 3px;" type="text" name="or_no_remarks" id="or_no_remarks" value="" onchange="updateorRemarks" placeholder='Input OR Remarks'>
                                                </td>
                                                <td class="td-btm pt-1 pb-1" align="center" style="padding:0px">
                                                    <input  style="border:0px solid #000;background: #dde1ff;padding: 3px;" type="text" name="def_int" id="def_int" value="" onchange="updateDefInt" placeholder='Input Def Int'>
                                                </td>
