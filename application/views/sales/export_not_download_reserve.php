        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 col-sm-6">
                    <div class="card">
                    <form method="POST" action="<?php echo base_url(); ?>sales/pdf_scan_directory_reserve">
                    <!-- <form method="POST" action="http://tradingsvr/accounting/sales/pdf_scan_directory"> -->
                            <div class="card-header">
                                <div class="d-flex justify-content-start">  
                                    <div>
                                        <a href="<?php echo base_url(); ?>sales/collection_reserve_list" class="btn btn-warning mr-2">Back</a>
                                    </div>
                                    <div>
                                        <h4 class="pt-1">Reserve Collection List</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
