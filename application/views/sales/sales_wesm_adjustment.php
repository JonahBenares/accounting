                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning alert-dismissible fade show mt-2" role="alert">
                                    ...
                                    <a href="<?php echo base_url(); ?>sales/export_not_download_sales_wesm_adjustment/<?php echo $ref_no;?>/<?php echo $due_date_from;?>/<?php echo $due_date_to;?>/<?php echo $in_ex_sub;?>/<?php echo $part_name;?>/" target="_blank"><u>Click here</u></a> to check if downloaded files are complete.
