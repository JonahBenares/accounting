        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12 col-sm-6">
                    <div class="card">
                    <!-- <form method="POST" action="http://tradingsvr/accounting/sales/sales_wesm_adjustment_pdf_scan_directory"> -->
                    <form method="POST" action="<?php echo base_url(); ?>sales/sales_wesm_adjustment_pdf_scan_directory">
                            <div class="card-header">
                                <div class="d-flex justify-content-start">  
                                    ...
                                    <div>
                                        <h4 class="pt-1">WESM Transaction - Sales Adjustment</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
