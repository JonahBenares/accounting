                        ...
                        <form>
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-warning alert-dismissible fade show mt-2" role="alert">
                                    ...
                                    <a href="http://localhost/accounting/sales/export_not_download/<?php echo $date; ?>/<?php echo $ref_no; ?>/<?php echo $buyer_fullname; ?>" target="_blank"><u>Click here</u></a> to check if downloaded files are complete.
                                ...
                                <?php if(!empty($collection)){ ?>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <a href="<?php echo base_url();?>sales/PDF_OR_bulk/<?php echo $date;?>/<?php echo $ref_no;?>/<?php echo $buyer_fullname;?>" target='_blank' class="btn btn-success btn-block" id="export">Export Bulk PDF</a> 
                                        </div>
