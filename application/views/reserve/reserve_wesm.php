                            ...
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-between gap-2">
                                                        <button type="button" onclick="filterReserve();" class="btn btn-primary flex-fill mr-1">Filter</button>
                                                        <button type="button" onclick="resetBulkReserve('<?php echo $ref_no; ?>');" 
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="billfrom" id="billfrom" value="<?php echo $billfrom; ?>">
                                            ...
                                            <tr>
                                                <td align="center" style="background: #fff;">                                                 
                                                    <div class="btn-group mb-0">
                                                        <a href="<?php echo base_url(); ?>reserve/print_2307_reserve/<?php echo $d['reserve_id']; ?>/<?php echo $d['reserve_detail_id']; ?>" target="_blank" class="btn btn-success btn-sm"title="Print BIR Form No.2307">
                                                ...
                                                <td align="right" style="padding:0px">
                                                    <input type="text" class="form-control" onblur="updateReserve('<?php echo base_url(); ?>','<?php echo $x; ?>','<?php echo $d['reserve_detail_id']; ?>','<?php echo $d['reserve_id']; ?>','<?php echo $d['billing_id']; ?>')" name="or_no" id="or_no<?php echo $x; ?>" value="<?php echo $d['or_no'];?>">
                                                </td>
                                                <td align="right" style="padding:0px">
                                                    <input type="text" class="form-control" onblur="updateReserve('<?php echo base_url(); ?>','<?php echo $x; ?>','<?php echo $d['reserve_detail_id']; ?>','<?php echo $d['reserve_id']; ?>','<?php echo $d['billing_id']; ?>')" name="total_update" id="total_update<?php echo $x; ?>" value="<?php echo $d['total_update']; ?>">
                                                </td>
                                                <td align="center">
                                                    <span class="m-b-10">Yes</span>
                                                    <label style="width:20px;margin: 0px 6px;">
                                                        <input type="radio"  onchange="updateReserve('<?php echo base_url(); ?>','<?php echo $x; ?>','<?php echo $d['reserve_detail_id']; ?>','<?php echo $d['reserve_id']; ?>','<?php echo $d['billing_id']; ?>')" name="orig_copy<?php echo $x; ?>" id="orig_yes<?php echo $x; ?>" value='1' <?php echo ($d['original_copy']=='1') ? 'checked' : ''; ?>>
                                                    </label>
                                                    <span class="m-b-10">No</span>
                                                    <label style="width:20px;margin: 0px 6px;">
                                                        <input type="radio" onchange="updateReserve('<?php echo base_url(); ?>','<?php echo $x; ?>','<?php echo $d['reserve_detail_id']; ?>','<?php echo $d['reserve_id']; ?>','<?php echo $d['billing_id']; ?>')" name="orig_copy<?php echo $x; ?>" id="orig_no<?php echo $x; ?>" value='2' <?php echo ($d['original_copy']=='0') ? 'checked' : ''; ?>>
                                                    </label>
                                                </td>
                                                <td align="center">
                                                    <span class="m-b-10">Yes</span>
                                                    <label style="width:20px;margin: 0px 6px;">
                                                        <input type="radio"  onchange="updateReserve('<?php echo base_url(); ?>','<?php echo $x; ?>','<?php echo $d['reserve_detail_id']; ?>','<?php echo $d['reserve_id']; ?>','<?php echo $d['billing_id']; ?>')" name="scanned_copy<?php echo $x; ?>" id="scanned_yes<?php echo $x; ?>" value='1' <?php echo ($d['scanned_copy']=='1') ? 'checked' : ''; ?>>
                                                    </label>
                                                    <span class="m-b-10">No</span>
                                                    <label style="width:20px;margin: 0px 6px;">
                                                        <input type="radio" onchange="updateReserve('<?php echo base_url(); ?>','<?php echo $x; ?>','<?php echo $d['reserve_detail_id']; ?>','<?php echo $d['reserve_id']; ?>','<?php echo $d['billing_id']; ?>')" name="scanned_copy<?php echo $x; ?>" id="scanned_no<?php echo $x; ?>" value='2' <?php echo ($d['scanned_copy']=='0') ? 'checked' : ''; ?>>
                                                    </label>
                                                </td>
                                            </tr>
                                            <?php } $x++; } ?>
                                ...
                                <?php }else{ ?>
                                    ...
                                    <?php if(isset($or_nos) && isset($original_copy) && isset($scanned_copy)){ ?>
                                        <a href="<?php echo base_url(); ?>reserve/reserve_wesm" class="btn btn-warning btn-block">Remove Filter</a>
                                    <?php } ?>
                                <?php } ?>
                            </div>
...
<script type="text/javascript">
    function resetBulkReserve(reference_no) {
        ...
        var redirect = loc+"reserve/reset_bulk_reserve";
