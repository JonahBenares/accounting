                ...
                <div class="col-12 col-md-12 col-lg-12 col-sm-6">
                    <div class="card">
                        <div class="card-header">
                            <h4>Bulk Reserve OR Update - Purchases</h4>
                        </div>
                        <div class="card-body">
                            <form id='orbulk'> 
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 offset-lg-2" >
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="reserve_id" id="reserve_id">
                                                        <option value=''>-- Select Reference No --</option>
                                                        <?php 
                                                            foreach($reference AS $r){
                                                        ?>
                                                        <option value="<?php echo $r->reserve_id; ?>"><?php echo $r->reference_number; ?></option>
                                                        <?php } ?>
                                            </select>
                                            <?php } else { ?>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <?php if(empty($reserve_id) && empty($identifier)){ ?>
                            ...
                            <?php if(!empty($reserve_id)){ if($saved==0){ ?>
