                ...
                <div class="col-12 col-md-12 col-lg-12 col-sm-6">
                    <div class="card">
                        <div class="card-header">
                            <h4>WESM Transaction - Purchases Reserve (Unsaved)</h4>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input type='hidden' name='baseurl' id='baseurl' value='<?php echo base_url(); ?>'>
                                                 <button type="button" class="btn btn-primary btn-sm text-white" style="margin-right: 2px;" onclick="save_unsaved_purchases('<?php echo $d['reserve_id']; ?>','<?php echo $d['reference_number']; ?>')">
                                                    <span class="fas fa-check" style="margin:0px"></span>
                                                </button>
                                                <button type="button" class="btn btn-danger btn-sm text-white" onclick="delete_unsaved_purchases('<?php echo $d['reserve_id']; ?>','<?php echo $d['reference_number']; ?>')">
...
<script type="text/javascript">
    ...
    function save_unsaved_purchases(reserve_id,reference_no) {
        var loc= document.getElementById("baseurl").value;
        var redirect = loc+"reserve/save_unsaved_reserve";
    ...
    function delete_unsaved_purchases(reserve_id,reference_no){
        var loc= document.getElementById("baseurl").value;
