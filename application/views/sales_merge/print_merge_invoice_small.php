...
<page size="A4" class="first-main">
    ...
    <!-- <div class="charges"><?php echo "Sales for ".date("F Y",strtotime($due_date[$x]))?></div> -->
    <div class="charges"><?php echo "Energy Sales for the month of ".date("F Y",strtotime($billing_to[$x])) ?></div>
