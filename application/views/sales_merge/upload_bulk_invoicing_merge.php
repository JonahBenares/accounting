                ...
                <div class="col-12 col-md-12 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Bulk Upload - Invoicing of Sales (Merge)</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <?php if(empty($year_disp) && empty($reference_number) && empty($due_date) && empty($identifier)){ ?>
                                             ...
                                             <?php } elseif ($saved==0){ ?>
                                                 <input type='button' class="btn btn-danger" id="cancel_bulk_invoicing" onclick="cancelSalesMergeInvoicing()" value="Cancel Transaction" style="width:100%">
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <!-- <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-6 col-md-6 offset-md-3 offset-lg-3">
                                            <div class="form-group mb-0">
                                                <div class="input-group mb-0">
                                                    <input type="file" class="form-control" name="doc" placeholder="" id="bulkinvoicing_merge">
                                                    <div class="input-group-append">
                                                        <button class="btn btn-primary" id="proceed_bulkinvoicing_merge" onclick="upload_bulkinvoicing_merge()"  type="button">Upload</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
