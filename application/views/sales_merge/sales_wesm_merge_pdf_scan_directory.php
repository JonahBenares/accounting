...
<body>
    ...
    <div id="contentPDF" >
        <page size="Long" id="printableArea" class="canvas_div_pdf<?php echo $x; ?>" >
            ...
            <div class="">
                ...
                <label class="desc_1"><?php echo "Energy Sales for the month of ".date("F Y",strtotime($d['billing_to'])) ?></label>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
            ...
            var redirect = loc+"salesmerge/update_sales_wesm_merge_flag";
