...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/salesmerge.js"></script>
<form id='InsertBSM'>
<div style="margin-top:10px" id="printbutton">
    <center>
        <button onclick="goBack()" class="btn btn-warning ">Back</button>
        <input type="button" id="saved" name="submit" class="btn btn-success btn-block  btn-md" value = "Print" onclick="printbsm_history(this);return false;">
        <input type='hidden' name='baseurl' id='baseurl' value="<?php echo base_url(); ?>">
        <a href='<?php echo base_url(); ?>salesmerge/print_merge_invoice_small/<?php echo $invoice_no; ?>/<?php echo $print_identifier; ?>/<?php echo $count; ?>' class="btn btn-primary button" target="_blank">Invoice (small)</a> 
        <a href='<?php echo base_url(); ?>salesmerge/print_merge_invoice_half/<?php echo $invoice_no; ?>/<?php echo $print_identifier; ?>/<?php echo $count; ?>' class="btn btn-primary button" target="_blank">Invoice (half)</a> 
        <a href='<?php echo base_url(); ?>salesmerge/print_merge_invoice_main/<?php echo $invoice_no; ?>/<?php echo $print_identifier; ?>/<?php echo $count; ?>' class="btn btn-primary button" target="_blank">Invoice New</a> 
            ...
            <tr>
                <td colspan="20">
                    <table width="100%" class="">
                        ...
                        <tr>
                            <td width="19%" align="center" class="bor-btm font-10"><?php echo ($bsm_head_id[$y]!='') ? strtoupper($fullname[$y]) : strtoupper($_SESSION['fullname']); ?></td>
                            <input type="hidden" id="prepared_by" name="prepared_by[]" class="form-control" value="<?php echo $_SESSION['user_id']; ?>">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="bor-btm font-10"><?php echo ($bsm_head_id[$y]!='') ? $checked_by_emg[$y] : 'JOEMAR DELOS SANTOS'; ?></td>
                            <input type="hidden" id="checked_by_emg" name="checked_by_emg[]" class="form-control" value="JOEMAR DELOS SANTOS">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="bor-btm font-10"><?php echo ($bsm_head_id[$y]!='') ? $checked_by_accounting[$y] : 'CRISTY CESAR'; ?></td>
                            <input type="hidden" id="checked_by_accounting" name="checked_by_accounting[]" class="form-control" value="CRISTY CESAR">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="bor-btm font-10"><?php echo ($bsm_head_id[$y]!='') ? $checked_by_finance[$y] : 'ZYNDYRYN PASTERA'; ?></td>
                            <input type="hidden" id="checked_by_finance" name="checked_by_finance[]" class="form-control" value="ZYNDYRYN PASTERA">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="bor-btm font-10"><?php echo ($bsm_head_id[$y]!='') ? $noted_by[$y] : 'MILA ARANA'; ?></td>
                            <input type="hidden" id="noted_by" name="noted_by[]" class="form-control" value="MILA ARANA">
                            <td width="1%"></td>
                        </tr>
                        <tr>
                            <td width="19%" align="center" class="font-11"><?php echo ($bsm_head_id[$y] != '') ? $prepared_by_pos[$y] : 'Billing'; ?></td>
                            <td width="1%"></td>
                            <td width="19%" align="center" class="font-11"><?php echo ($bsm_head_id[$y]!='') ? $checked_by_emg_pos[$y] : 'EMG'; ?></td>
                            <input type="hidden" id="checked_by_emg_pos" name="checked_by_emg_pos[]" class="form-control" value="EMG">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="font-11"><?php echo ($bsm_head_id[$y]!='') ? $checked_by_accounting_pos[$y] : 'Accounting'; ?></td>
                            <input type="hidden" id="checked_by_accounting_pos" name="checked_by_accounting_pos[]" class="form-control" value="Accounting">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="font-11"><?php echo ($bsm_head_id[$y]!='') ? $checked_by_finance_pos[$y] : 'Finance'; ?></td>
                            <input type="hidden" id="checked_by_finance_pos" name="checked_by_finance_pos[]" class="form-control" value="Finance">
                            <td width="1%"></td>
                            <td width="19%" align="center" class="font-11"><?php echo ($bsm_head_id[$y]!='') ? $noted_by_pos[$y] : 'General Manager'; ?></td>
