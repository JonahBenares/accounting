                        ...
                        <form>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table-bsordered" width="100%">
                                    ...
                                    <tr>
                                        <td colspan="2"><center><a href='<?php echo base_url(); ?>purchases/download_bulk_adjustment/<?php echo $ref_no; ?>/<?php echo $due_date; ?>/<?php echo $in_ex_sub; ?>' target="_blank" class="btn btn-primary btn-block">Download Bulk 2307</a>
                                        </center></td>
                                        <td colspan="2"><center><a href='<?php echo base_url(); ?>purchases/download_bulk_zoomed_adjustment/<?php echo $ref_no; ?>/<?php echo $due_date; ?>/<?php echo $in_ex_sub; ?>' target="_blank" class="btn btn-info btn-block">Download Bulk 2307 (Zoomed)</a>
                                        </center></td>
                                    </tr>
                                    <tr>
                                        <td id="append"></td>
