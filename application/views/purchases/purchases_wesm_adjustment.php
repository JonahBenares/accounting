                                    ...
                                    <table class="table-bordered table table-hover " id="table-6" style="width:300%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="position:sticky; left:507px;min-width: 5px; z-index: 10;background: rgb(240 240 240);">Due Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="position:sticky; left:507px;min-width: 5px; z-index: 10;background: #fff"><?php echo date("M. d, Y",strtotime($d['due_date'])); ?></td>
