...
<html lang="en">
    ...
    <div style="padding-bottom:90px;">
        <div id="contentPDF" >
            <page size="Long"  class="canvas_div_pdf" style="position: absolute;">
            ...
            <page size="Long"  class="canvas_div_pdf" style="position: absolute;margin-top: 1350px;">
                <img class="img2307" src="<?php echo base_url(); ?>assets/img/form2307.jpg" style="width: 100%;">
                <label class="period_from "><?php echo $period_from; ?></label>
                <label class="period_to"><?php echo $period_to; ?></label>
                <?php $tin=explode("-",$tin); ?>
        ...
        /*    
            ...
            for (var i = 1; i <= totalPDFPages; i++) { 
                ...
                pdf.addImage(imgData, 'JPG', top_left_margin, -(PDF_Height*i)+(top_left_margin*4),canvas_image_width,canvas_image_height);
                    ...
                    let rno = refno.split("-");
                    let newref = rno[2] + substr(rno[3],0,-1);
