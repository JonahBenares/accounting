                            ...
                            <tr>
                                <td colspan="20">
                                    ...
                                    <table width="100%" class="table-bordered">
                                        ...
                                        <tr>
                                            <td colspan="15" align="right">Vatable Purchases</td>
                                            <td colspan="4" align="center"><?php echo "₱ ".$vat_purchase_peso; ?></td>
                                            <td colspan="1"><?php echo $vat_purchase_cents; ?></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="15" align="right">Zero Rated Ecozones Purchases</td>
