        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <button class="btn btn-primary mr-1 btn-block" value="Save" onclick="parent.window.opener.location='<?php echo base_url(); ?>purchases/print_2307sample'; window.close();">Save and Print</button>
                </div>
            </div>
        </div>
    </form>
